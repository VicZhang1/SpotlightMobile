...
using SpotlightExpress.Helpers;
using SpotlightExpress.Services;
using SpotlightExpress.Views;
using Xamarin.Forms;
using Xamarin.Forms.Xaml;

[assembly: XamlCompilation(XamlCompilationOptions.Compile)]
namespace SpotlightExpress
{
	public partial class App : Application
	{
		...
		public static string AzureMobileAppUrl = "https://SpotlightMobile.azurewebsites.net";
